...
@Component({
  selector: 'app-jsav-binary-search',
  templateUrl: './jsav-binary-search.component.html',
  styleUrls: ['./jsav-binary-search.component.css']
})
export class JsavBinarySearchComponent implements AfterViewInit {
  @Input() sizes;
  ngAfterViewInit() {
